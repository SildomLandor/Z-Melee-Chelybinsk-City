...
ZBCVAR.MoveSpeedMult =          CreateConVar("zbase_speed_mult", "1.3", flags)
ZBCVAR.WepAccuracyMult =        CreateConVar("zbase_wep_accuracy", "0.5", flags)
ZBCVAR.PlayerHurtAllies =       CreateConVar("zbase_ply_hurt_ally", "1", flags)
ZBCVAR.FriendlyFire =           CreateConVar("zbase_friendly_fire", "1", flags)

ZBCVAR.Nerf =                   CreateConVar("zbase_nerf", "1", flags)
ZBCVAR.GrenCount =              CreateConVar("zbase_gren_count", "2", flags)
ZBCVAR.AltCount =               CreateConVar("zbase_alt_count", "2", flags)
ZBCVAR.GrenAltRand =            CreateConVar("zbase_gren_alt_rand", "1", flags)
...
ZBCVAR.ArmorSparks =            CreateConVar("zbase_armor_sparks", "2", flags)
ZBCVAR.MuzzleLight =            CreateConVar("zbase_muzzle_light", "2", flags)
...
ZBCVAR.SightDist =              CreateConVar("zbase_sightdist", "3000000", flags)
ZBCVAR.SightDistOverride =      CreateConVar("zbase_sightdist_override", "1", flags)
...
ZBCVAR.RebelAmmo =              CreateConVar("zbase_reb_ammo", "1", flags)

ZBCVAR.MetroCopGlowEyes =       CreateConVar("zbase_metrocop_glow_eyes", "1", flags)
...
ZBCVAR.CampaignReplace =        CreateConVar("zbase_camp_replace", "1", flags)
...
if CLIENT then
    ...
    ZBCVAR.PopUp =              CreateConVar("zbase_popup", "0", FCVAR_ARCHIVE)
