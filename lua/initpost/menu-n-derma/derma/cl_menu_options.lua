...
--hg.settings:AddOpt("Прочее","hg_coolvetica", "Шрифт Coolvetica")
...
--hg.settings:AddOpt("Звук","hg_thirdperson","От третьего лица",false,true)
--^^ СТРИНГ ИНПУТ
--hg.settings:AddOpt("Геймплей","sensitivity", "Чувствительность мыши", true)
--hg.settings:AddOpt("Геймплей","hg_old_notificate", "Старые уведомления")
--hg.settings:AddOpt("Геймплей","hg_random_appearance", "Вкл/Выкл случайный внешний вид")
--hg.settings:AddOpt("Геймплей","hg_cheats", "Вкл/Выкл читы")
