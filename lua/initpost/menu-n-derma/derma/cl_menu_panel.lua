...
function PANEL:CreateTraitorMenuPanel()
    ...
    local Skillsets = {
        ...
        ["diversant"] = {cost = 11, name = "Диверсант", desc = "Крадёт снаряжение со спины, режет горло острым предметом, переодевается в трупы. Тихий бег без следов. Рация-приманка и парализующий шприц."},
        ["assassin"] = {cost = 30, name = "Ассасин", desc = "Быстро обезоруживает людей, опытен в стрельбе."},
