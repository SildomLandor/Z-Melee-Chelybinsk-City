...
SWEP.Instructions = "Большой бинт, поможет остановить легкое кровотечение. Так как бинт не в упаковке, вероятность того, что он стерилизован, мала. ПКМ, чтобы использовать его на кого-нибудь другом."
SWEP.Spawnable = true
