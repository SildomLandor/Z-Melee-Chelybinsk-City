...
SWEP.PrintName = "Гравитационная пушка"
SWEP.Instructions = "Манипулятор энергетического поля нулевой точки. \\nИзвестное как Гравитационная пушка, представляет собой оружие притягивающего луча, предназначенное для обращения с опасными материалами.\\n\\nЛКМ, чтобы бросить, ПКМ, чтобы тянуть"
