...
SWEP.Instructions = "Обычный бытовой молоток, имеющий тупую и острую сторону. Используйте его, чтобы заблокировать пути или запретить кому-либо двигаться.\\n\\nЛКМ, чтобы атаковать.\\nR + ЛКМ, чтобы изменить режим атаки.\\nПКМ, чтобы заблокировать.\\nПКМ + ЛКМ, чтобы прибить или бросить."
