...
SWEP.PrintName = "Мушкет" -- "Brown Bess"
SWEP.Author = "Various Great Britain manufacturers"
SWEP.Instructions = "Мушкет — длинноствольное ружье с дульным заряжанием, возникшее как гладкоствольное оружие в начале 16 века, использовавшее черный порох калибра 20 мм."
