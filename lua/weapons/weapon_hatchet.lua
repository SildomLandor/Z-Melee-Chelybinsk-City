...
SWEP.Instructions = "Одноручный ударный инструмент с острым лезвием с одной стороны, используемым для резки и раскалывания древесины, и молотком с другой стороны.\\n\\nЛКМ для атаки.\\nПКМ для блока.\\nПКМ + ЛКМ, чтобы бросить."
