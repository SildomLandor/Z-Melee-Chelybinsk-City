...
SWEP.Instructions = "Традиционная японская катана с изогнутым однолезвийным лезвием, обеспечивающим точность и баланс. Легкий и эффективный, он обеспечивает быстрые, контролируемые удары и плавное управление на близком расстоянии.\\n\\nЛКМ для атаки.\\nПКМ для блокировки."
