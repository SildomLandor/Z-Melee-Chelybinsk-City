...
SWEP.PrintName = "Жгут"
SWEP.Instructions = "Жгут Эсмарха, предназначенный для остановки крупных (артериальных) кровотечений. Также может использоваться для остановки легких кровотечений, хотя и делает конечность неэффективной."
