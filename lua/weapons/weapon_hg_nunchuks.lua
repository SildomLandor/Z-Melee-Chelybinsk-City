...
SWEP.PrintName = "Нунчаки"
SWEP.Instructions = "Пара традиционных нунчаков — две короткие клюшки, соединенные цепью, — предназначенные для быстрых, плавных ударов и защитного контроля. Легкие и маневренные, они ценят расчет и точность, а не грубую силу.\\n\\nЛКМ для атаки.\\nПКМ для блокировки.\\nE + ЛКМ для специальной атаки."
