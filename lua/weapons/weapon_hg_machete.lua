...
SWEP.Instructions = "Мачете — это широкое лезвие, используемое либо в качестве сельскохозяйственного орудия, похожего на топор, либо в бою, как нож с длинным лезвием.\\n\\nЛКМ для атаки.\\nПКМ, чтобы блокировать."
