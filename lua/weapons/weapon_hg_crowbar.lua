...
SWEP.PrintName = "Лом"
SWEP.Instructions = "Лом — двуручный инструмент, который можно использовать как оружие ближнего боя. Это также знаковое фирменное оружие Гордона Фримена. Может выломать двери.\\n\\nЛКМ, чтобы атаковать.\\nПКМ, чтобы заблокировать."
