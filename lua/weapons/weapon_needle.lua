...
SWEP.Instructions = "Игольная декомпрессия применяется при лечении напряженного пневмоторакса. ЛКМ, чтобы использовать на себя; ПКМ, чтобы использовать его на ком-то другом."
