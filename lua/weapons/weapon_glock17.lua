...
SWEP.PrintName = "Глок 17"
SWEP.Author = "Glock GmbH"
SWEP.Instructions = "Glock — марка полуавтоматических пистолетов с полимерной рамкой, короткой отдачей, ударником и затвором, разработанных и производимых австрийским производителем Glock Ges.m.b.H. Эта версия Глока имеет 17 патронов под патрон 9х19."
