...
SWEP.Author = "Taser"
SWEP.Instructions = "Тазер - это электрошоковое устройство, предназначенное для временного обездвиживания человека на расстоянии. Позволяет подойти к цели и нейтрализовать её с минимальным риском и травмами."
