...
SWEP.PrintName = "Бита с проволокой"
SWEP.Instructions = "Могучая Бита, оснащенная колючей проволокой. Может сломать череп, используйте осторожно.\\n\\nЛКМ для атаки.\\nПКМ, чтобы заблокировать.\\nE+ЛКМ, чтобы зарядить мощную атаку."
