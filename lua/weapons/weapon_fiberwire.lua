...
SWEP.PrintName = "Волоконный провод"
SWEP.Instructions = "Это одна цилиндрическая гибкая металлическая полоса, соединенная с двумя эргономичными ручками из углеродного волокна и металла. Используйте его, чтобы чуждать людей.\\n\\nЛКМ, чтобы раскачиваться.\\nПри удушении нажмите ЛКМ, чтобы остановить удушение."
