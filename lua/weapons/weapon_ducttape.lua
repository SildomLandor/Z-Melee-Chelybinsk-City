...
SWEP.PrintName = "Клейкая лента"
SWEP.Instructions = "Армированная изолента, пригодится, если вы террорист и хотите взять кого-то в плен. Это также полезно для создания баррикад."
