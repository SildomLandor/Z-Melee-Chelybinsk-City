...
SWEP.PrintName = "Тяжелый драгунский пистолет"
SWEP.Author = "N/A"
SWEP.Instructions = "Это кремневый пистолет с дульным замком, который появился как оружие самообороны и как военное оружие в начале 16 века, используя черный порох и калибр 20 мм."
