--[[ 
    TO-DO:
        - Конструктор паков музыки чтобы игра брала музыку из файлов игрока он их называл там a1.mp3-это эмбиент
        c1-это бой 
        он создовал папку у себя в garrysmod/sound/название пакпки которую укажет игрок
        - Возможность выбрать пак музыки для режимов где нет определенного класса музыки.
        - Возможность настроить громкость эмбианта и комбата
--]]
