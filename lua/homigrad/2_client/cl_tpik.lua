...
function hg.DoTPIK(ply, ent)
    ...
    if lerp_rh != 0 then
        ...
        segments[3] = segments[3] or {Pos = ply_r_hand_matrix:GetTranslation(), Len = limblength}
    ...
    if lerp_lh != 0 then
        ...
        segments[3] = segments[3] or {Pos = ply_l_hand_matrix:GetTranslation(), Len = limblength}
