...
hg.blood_react_phrases = {
	...
	"Пахнет... Кровью?",
    "Такой резкий запах меди и мускуса... странно",
    "Чувствую... Пахнет железом...",
    "Запах такой... Медный? Это кровь? ",
...
local random_phrase = {
    ...
    "Мне кажется, у меня было другое имя...",
	"Такое ощущение что я забыл что-то важное.",
	"Моя память... в ней какие-то пробелы...",
	"Я чувствую себя... неполноценным?",
	"Стоп... А как я сюда попал..?",

    -- Место и полигон
    "Это место... Оно ненастоящее?",
    "Это место... будто кто-то построил его специально?",
    "Это место выглядит знакомо... и всё же чуждо?",
    "Камеры... я чувствую, что за что-то наблюдает.",

    -- Чистилище
    "Белая комната... Белая комната?",
    "Иногда я слышу тишину. Она пугает больше криков.",
    "Пустота — худшее наказание. Смерть была бы милосерднее.",

    -- Петля сессий / Цикл
    "Дежавю...",
    "Я уже был здесь? Только стены были другого цвета.",
    "Ощущение что я... умер?",

    -- Полицейский и Ганмен
    "Я видел человека в форме. Он шёл ко мне.",
    "Кто-то возвращается после смерти. Я слышал.",
    "Жертва знает больше, чем убийца. Это странно.",
    "Пистолет... мне будто знаком этот вес.",
    "Оружие не должно быть у того, кто боится. Но у меня.",
    "Ганмен — всего лишь инструмент. Но я не хочу быть инструментом.",

    -- Атмосфера и эксперимент
    "Запах меди. Опять.",
    "Это эксперимент, да? И мы внутри.",
    "Кто нас сюда привёл? Нет, не мы сами.",
    "Если бы можно было вспомнить... стереть всё и начать.",
    "Может, реальность снаружи не лучше, чем здесь.",
    "Они изучают нас. Наш страх, нашу ярость.",
    "Я не подопытный. Я не число. Я человек.",
}
