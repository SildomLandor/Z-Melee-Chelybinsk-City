...
local random_phrase = {
    ...
    "Ощущение что я... умирал?",
}

local fear_hurt_ironic = {
	"Наверное, из этого стоит вынести урок... Если я выживу.",
	"Будущий биограф не поверит что я пережил это... Как и я сам.",
	"В следующий раз, может, стоит быть чуть осторожнее... Если следующий раз будет.",
	"Зато я прожил нассыщенную жизнь.",
	"Я буду больше ценить жизнь... Если я выживу.",
	"Я... Кажется, я уже переживал что-то подобное.",
}
...
local fear_phrases = {
	...
	"Надо было воспринимать всё серьёзнее.",
