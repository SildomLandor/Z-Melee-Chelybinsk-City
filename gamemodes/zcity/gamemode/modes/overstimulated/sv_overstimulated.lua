...
MODE.PrintName = "Передозированный"
...
MODE.LootTable = {
	{100, {
        ...
        {5, "weapon_hammer"},
        {5, "weapon_hg_bottle"},
        {5, "weapon_buck200knife"},
        {5, "weapon_wrench"},
        {5, "weapon_hg_cinderblock"},
        {5, "weapon_scalpel"},
        {5, "weapon_screwdriver"},
        {5, "weapon_drill"},
        {5, "weapon_hg_shovel"},
        {5, "weapon_hg_crowbar"},
...
function MODE:GiveVictimLoadout(ply)
	...
	zb.GiveRole(ply, "Жертва", Color(255,255,255))
...
function MODE:SpawnShooter(ply)
	...
	if shooterIndex == 1 then
		GiveWeaponWithReserve(ply, "weapon_saiga12", 7)
		...
		hg.AddArmor(ply, {"ent_armor_mask3", "ent_armor_vest1"})
	elseif shooterIndex == 2 then
		GiveWeaponWithReserve(ply, "weapon_hg_bow", 24)
		GiveWeaponWithReserve(ply, "weapon_pm9", 5)
		...
		GiveWeaponWithReserve(ply, "weapon_akmwreked", 5)
		GiveWeaponWithReserve(ply, "weapon_revolver2", 4)
