...
function MODE:HUDPaint()
	...
	if hg and hg.PluvTown and hg.PluvTown.Active and hg.PluvTown.PluvMadness then
...
-- Используем общий EndMenu из libraries/cl_endmenu.lua

function MODE:RoundStart()
    if zb and zb.EndMenu and zb.EndMenu.Close then
        zb.EndMenu.Close()
    end
end
