...
function EndMenu.Open(opts)
	...
	colHeader.Paint = function(_, hw, hh)
		...
		draw.SimpleText("Имя", "ZB_ScoreboardHeader", 8, hh * 0.5, col.headerText, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Убийства", "ZB_ScoreboardHeader", hw - 70, hh * 0.5, col.headerText, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		--surface.SetDrawColor(col.separator)
